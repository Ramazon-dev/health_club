...
///
/// {@tool dartpad}
/// This example shows the [BottomAppBarWidget], which can be configured to have a notch using the
/// [BottomAppBarWidget.shape] property. This also includes an optional [FloatingActionButton], which illustrates
/// the [FloatingActionButtonLocation]s in relation to the [BottomAppBarWidget].
///
/// ** See code in examples/api/lib/material/bottom_app_bar/bottom_app_bar.1.dart **
/// {@end-tool}
///
/// {@tool dartpad}
/// This example shows Material 3 [BottomAppBarWidget] with its expected look and behaviors.
///
...
/// See also:
///
///  * [NotchedShape] which calculates the notch for a notched [BottomAppBarWidget].
///  * [FloatingActionButton] which the [BottomAppBarWidget] makes a notch for.
...
class BottomAppBarWidget extends StatefulWidget {
  ...
  /// The amount of space to surround the child inside the bounds of the [BottomAppBarWidget].
  ///
  ...
  /// The margin between the [FloatingActionButton] and the [BottomAppBarWidget]'s
  /// notch.
  ///
  ...
  /// The double value used to indicate the height of the [BottomAppBarWidget].
  ///
  ...
  @override
  State createState() => _BottomAppBarWidgetState();
}
